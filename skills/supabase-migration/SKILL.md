...
description: "Database migration toolkit for Supabase projects. Use when: (1) Creating new migration files, (2) Writing schema changes (CREATE TABLE, ALTER, etc.), (3) Adding indexes, triggers, or RLS policies, (4) Validating migration conventions, (5) Running migrations locally, (6) Naming database objects"
...
CREATE POLICY pc_examples_select ON tb_examples FOR SELECT USING (true);
